...
class RegistrationMongoRepositoryISpec
  ...
  private val reg = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
  private val reg2 = PAYERegistration(registrationID = "AC234567", transactionID = "NN5678", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.held, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)

  // Company Details
  private val regNoCompanyDetails = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = None, directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
  private val companyDetails2: CompanyDetails = CompanyDetails(companyName = "tstCcompany2", tradingName = Some("tstTradingName2"), roAddress = address, ppobAddress = ppobAddress, businessContactDetails = businessContact)
  private val regUpdatedCompanyDetails = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails2), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)

  // Employment
  private val regNoEmployment = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
  private val employmentDetails2: Employment = Employment(employees = true, companyPension = Some(false), subcontractors = true, date)
  private val regUpdatedEmployment = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, Some(employmentDetails2), sicCodes = Seq.empty)
  ...
  private val regUpdatedDirectors = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = directors, payeContact = None, None, sicCodes = Seq.empty)

  //SIC Codes
  private val regNoSICCodes = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
  ...
  //PAYE Contact
  private val regNoPAYEContact = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
  ...
  private val regUpdatedPAYEContact = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = Some(payeContact), None, sicCodes = Seq.empty)

  //Completion Capacity
  private val regNoCompletionCapacity = PAYERegistration(registrationID = "AC123456", transactionID = "NN1234", internalID = "09876", acknowledgementReference = Some("testAckRef"), registrationConfirmation = Some(EmpRefNotification(Some("testEmpRef"), "2017-01-01T12:00:00Z", "testStatus")), formCreationTimestamp = "timestamp", eligibility = Some(Eligibility(false, false)), status = PAYEStatus.draft, completionCapacity = None, companyDetails = Some(companyDetails), directors = Seq.empty, payeContact = None, None, sicCodes = Seq.empty)
